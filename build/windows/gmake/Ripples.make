...
ifeq ($(config),debugweb)
  ...
  TARGETDIR  = ../../../bin/web
  TARGET     = $(TARGETDIR)/Ripples.js
  DEFINES   += -D__orxDEBUG__
  INCLUDES  += -I$(ORX)/include -I../../../include/extensions -I../../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) -ffast-math -g -DorxWEB_EXECUTABLE_NAME='"Ripples.wasm"' -pthread
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS) -fno-exceptions
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L$(ORX)/lib/static/web -L$(ORX)/../extern/emscripten-glfw/lib -L$(ORX)/../extern/basisu/lib/web -L$(ORX)/../extern/libwebp/lib/web -L$(ORX)/../extern/LiquidFun-1.1.0/lib/web -L. --preload-file ../../../build/Ripples.obr@/ -sPTHREAD_POOL_SIZE=navigator.hardwareConcurrency -sAUDIO_WORKLET=1 -sWASM_WORKERS=1 -sSTACK_SIZE=1048576 -sASYNCIFY -sALLOW_MEMORY_GROWTH -sFULL_ES3=1 -pthread -lidbfs.js $(ORX)/../extern/emscripten-glfw/lib/libglfw3.a --js-library $(ORX)/../extern/emscripten-glfw/lib/lib_emscripten_glfw3.js -gsource-map
  ...
  define PRELINKCMDS
	...
	cd ../../../bin && Ripples -b ../build/Ripples.obr
  endef
  define POSTBUILDCMDS
	@echo Running post-build commands
	del ..\..\..\build\Ripples.obr
  endef
endif
...
ifeq ($(config),profileweb)
  ...
  INCLUDES  += -I$(ORX)/include -I../../../include/extensions -I../../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS    += $(CFLAGS) $(ALL_CPPFLAGS) -ffast-math -g -O2 -DorxWEB_EXECUTABLE_NAME='"Ripples.wasm"' -pthread
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS) -fno-exceptions -fno-rtti
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L$(ORX)/lib/static/web -L$(ORX)/../extern/emscripten-glfw/lib -L$(ORX)/../extern/basisu/lib/web -L$(ORX)/../extern/libwebp/lib/web -L$(ORX)/../extern/LiquidFun-1.1.0/lib/web -L. --preload-file ../../../build/Ripples.obr@/ -sPTHREAD_POOL_SIZE=navigator.hardwareConcurrency -sAUDIO_WORKLET=1 -sWASM_WORKERS=1 -sSTACK_SIZE=1048576 -sASYNCIFY -sALLOW_MEMORY_GROWTH -sFULL_ES3=1 -pthread -lidbfs.js $(ORX)/../extern/emscripten-glfw/lib/libglfw3.a --js-library $(ORX)/../extern/emscripten-glfw/lib/lib_emscripten_glfw3.js -O2
...
$(OBJDIR)/Ripples.o: ../../../src/Ripples.cpp
	@echo $(notdir $<)
